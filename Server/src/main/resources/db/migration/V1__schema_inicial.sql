...
CREATE TABLE productos (
    ...
    id_um           BIGINT                 NOT NULL REFERENCES unidades_medida(id_um),
...
CREATE TABLE movimientos_caja (
    ...
    id_turno        BIGINT             NOT NULL REFERENCES turnos_caja(id_turno),
    id_usuario      BIGINT             NOT NULL REFERENCES usuarios(id_usuario),
...
INSERT INTO usuarios (nombre_completo, username, password_hash, rol) VALUES
    ('Administrador', 'admin', '$2b$12$E9dqgq0OepvADgcb7Dg24upUdx01aMjzhgHtRXw5pKSfJQP0fMMeq', 'ADMIN'),
    ('Cajero Demo',    'cajero', '$2b$12$E9dqgq0OepvADgcb7Dg24upUdx01aMjzhgHtRXw5pKSfJQP0fMMeq', 'CAJERO'),
    ('Almacenero Demo','almacen', '$2b$12$E9dqgq0OepvADgcb7Dg24upUdx01aMjzhgHtRXw5pKSfJQP0fMMeq', 'ALMACENERO');
