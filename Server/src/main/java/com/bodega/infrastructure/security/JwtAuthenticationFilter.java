...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (token != null && jwtService.esValido(token)) {
            ...
            var authentication = construirAutenticacion(claims);
    ...
    private UsernamePasswordAuthenticationToken construirAutenticacion(Claims claims) {
        var idUsuario = claims.get("id_usuario", Long.class);
